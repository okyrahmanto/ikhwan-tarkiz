...
import 'package:pemuda_bismillah/src/ui/home_drawer/navigation_home_screen.dart';
import 'package:pemuda_bismillah/src/ui/login/login.dart';
import 'package:pemuda_bismillah/src/ui/register/register_bloc.dart';
          ...
          child: ListView(
            children: <Widget>[
              Container(
                ...
                child: Center(
                    child: Image(
                  image: AssetImage('assets/logo/ic_bismillah_hitam.png'),
                ...
                child: new Row(
                  ...
                  children: <Widget>[
                    new Expanded(
                      ...
                      items: <String>['Banjarmasin','Banjarbaru','Balangan','Tapin','Banjar''Hulu Sungai Utara','Hulu Sungai Selatan','Hulu Sungai Tengah','Tabalong','Tanah Laut','Tanah Bumbu','Kotabaru','Lainnya']
                          .map<DropdownMenuItem<String>>((String value) {
                        return DropdownMenuItem<String>(
                          value: value,
                          child: Text(value),
