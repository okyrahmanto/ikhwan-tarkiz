(function ($) {
  ...
  $( document ).ready(function() {
    ...
    //
    // Countdown
    var time = '2020/04/05'; //Change this date with your counting date. Its Format is "Y/M/D"
    ...
    //
    // Google Map
    var mapLocation = new google.maps.LatLng(-3.324407, 114.601639); //change coordinates here
    var marker;
    var map;
    ...
    function initialize() {
      ...
      var contentString = '<div class="map-info-box">'
          ...
          + '<p class="map-address"><i class="ion-ios-location"></i> Banjarmasin, INA<br><i class="ion-ios-telephone"></i> 085345683025<br><i class="ion-email"></i> <a href="mailto:pemudabismillah@gmail.com">pemudabismillah@gmail.com</a></p>'
