...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="../../index3.html" class="brand-link">
      <img src="<?php echo base_url();?>assets/pemuda_bismillah/img/putih.png"
           alt="AdminLTE Logo"
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?php echo base_url()?>index.php/manager/management_artikel" class="nav-link">
              <i class="nav-icon fas fa-th"></i>
              <p>
                Manajemen Artikel
              </p>
          ...
          <li class="nav-item">
            <a href="<?php echo base_url()?>index.php/manager/management_sponsor" class="nav-link">
              <i class="nav-icon fas fa-th"></i>
              <p>
                Manajemen Sponsor
              </p>
          ...
          <li class="nav-item">
            <a href="<?php echo base_url()?>index.php/manager/management_peserta" class="nav-link">
              <i class="nav-icon fas fa-th"></i>
              <p>
                Manajemen Peserta
              </p>
