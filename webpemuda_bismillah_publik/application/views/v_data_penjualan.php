                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                              ...
                              <a href="<?php echo base_url() ?>index.php/admin/edit_penjualan/<?php echo $tampil->id_transaksi ?>" class="btn btn-warning">Edit</a>
...
<div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="hapus<?php echo $tampil->id_transaksi ?>" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form class="form-horizontal" action="<?php echo base_url('index.php/admin/hapus_transaksi_penjualan/')?><?php echo $tampil->id_transaksi ?>" method="post" enctype="multipart/form-data" role="form">
                  <div class="modal-body">
