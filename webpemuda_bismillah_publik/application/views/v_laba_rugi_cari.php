...
<!-- /.box-header -->
<div class="box-body">
<form method="get" action="<?php echo base_url('index.php/admin/laba_rugi_range')?>">
<div class="col-xs-11">
<div class="form-group col-xs-1"><label class="control-label">Mulai Tgl</label> </div>
<div class="form-group col-xs-3"><input type="date" class="form-control" name="tgl_mulai"/ required> </div>

<div class="form-group col-xs-1"><label class="control-label">Sampai Tgl</label> </div>
<div class="form-group col-xs-3"><input type="date" class="form-control" name="tgl_sampai"/ required=""> </div>
</div>
