...
<div id="notifikasi"><?php echo $this->session->flashdata('message');?></div>
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
                <form method="post" action="<?php echo base_url() ?>index.php/admin/proses_transaksi_pembelian">
                  ...
                  <table width="100%" border="0">
                    <tr>
                      <td>
                          <div class="form-group col-xs-6">
                             <label for="text">ID Vendor</label>
                              <select class="form-control" name="id_vendor" id="vendor">
                      ...
                      <td>
                        <div class="form-group col-xs-6">
                          <label for="text">No. Nota/Invoice</label>
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <input type="date" class="form-control" name="tgl_diterima" required="" value="<?php echo date('Y-m-d')?>">
                        </div>
                        ...
                        <div class="form-group col-xs-6">
                          ...
                          <select class="form-control" name="perihal" id="perihal">
                                ...
                                echo "<option value='".$data->id_perihal."'>".$data->nama_perihal."</option>";
                                }
                              ?>
                          </select>
                        </div>
                          ...
                          <table width="100%" border="1" class="table order-list table-bordered table-striped">
                            ...
                            <tbody>
                              <tr>
                                ...
                                <td style="display: none"><input type="text" name="merek[]" id="merek0" class="form-control"></td>
                                <td style="display: none"><input type="text" name="warna[]" id="warna0" class="form-control"></td>
                                ...
                                <td style="display: none"><input type="text" name="harga_kimia[]" id="harga_kimia0" class="form-control" onkeyup="sum(0);"></td>
                                ...
                                <td style="display: none"><input type="checkbox" name="sepasang[]" id="sepasang0" value="Ya"></td>
                    ...
                    <tr>
                      <td>
                          ...
                          <input type="number" name="diskon1" id="diskon1" class="form-control" onkeyup="total_diskon()" required="" style="font-weight: bold;font-size:14pt">
                          </div>
                          <div class="form-group col-xs-6">
                            <label for="text">Potongan(hasil)</label>
                            <input type="text" name="diskon2" id="diskon2"  class="form-control" style="text-align: right;font-weight: bold;font-size:14pt" readonly="">
                          </div>
                      </td>
                    </tr>
...
<script type="text/javascript">
    $(document).ready(function(){
        $('#vendor').change(function(){
            var id=$(this).val();
            $.ajax({
                url : "<?php echo base_url();?>index.php/admin/get_vendor",
                method : "POST",
                data : {id: id},
                dataType : 'json',
                  ...
                  console.log(data);
                   ...
                   var i;
                    for(i=0; i<data.length; i++){
                        html += '<b> Nama : '+data[i].nama_vendor+'<br/>'+
