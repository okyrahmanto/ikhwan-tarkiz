...
<head>
  ...
  <title>Pemuda Bismillah | Log in</title>
  ...
  <!-- icheck bootstrap -->
  <link rel="stylesheet" href="<?php echo base_url();?>assets/pemuda_bismillah/plugins/icheck-bootstrap/icheck-bootstrap.min.css">
  <!-- Theme style -->
...
<div class="login-box">
  <div class="login-logo">
    <a href="../tables/datainput.html"><b>Bismillah</b>Admin</a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
