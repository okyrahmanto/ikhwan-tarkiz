...
<?php
    if ($pembayaran->jenis_pembayaran=="utang") {
        echo '<input type="radio" name="opsi" value="utang" checked="true" class="detail">Utang';
    } else {
        echo '<input type="radio" name="opsi" value="utang" class="detail">Utang';
    }
    ?>

<br/>
<?php
    if ($pembayaran->jenis_pembayaran=="piutang") {
        echo '<input type="radio" name="opsi" value="piutang" checked="true" class="detail">Piutang';
    } else {
        echo '<input type="radio" name="opsi" value="piutang" class="detail">Piutang';
    }
    ?>
...
<?php
    foreach ($pelanggan as $data) {
        if ($pembayaran->id_pelanggan==$data->id_pelanggan) {
            echo "<option selected='selected' value='".$data->id_pelanggan."'>".$data->id_pelanggan." - ".$data->nama_pelanggan."  </option>";
        } else {
...
<?php
    foreach ($vendor as $data) {
        if ($pembayaran->id_pelanggan==$data->id_vendor) {
            echo "<option selected='selected' value='".$data->id_vendor."'>".$data->id_vendor." - ".$data->nama_vendor."  </option>";
        } else {
...
<input type="text" class="form-control" name="no_kontrak" required="" value="<?php echo $pembayaran->no_kontrak;?>">
</div>
<div class="form-group col-xs-6">
<label for="text">Tanggal</label>
<input type="date" class="form-control" name="tgl_pembayaran" required="" value="<?php echo $pembayaran->tgl_pembayaran; ?>">
</div>
</td>
