...
<div id="notifikasi"><?php echo $this->session->flashdata('message');?></div>
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
                <form method="post" action="<?php echo base_url() ?>index.php/admin/proses_edit_penjualan">

                  <input type="hidden" class="form-control" name="id_transaksi" value="<?php echo $penjualan->id_transaksi ?>">
                  ...
                  <table width="100%" border="0">
                    <tr>
                             ...
                             <label for="text">ID Kostumer</label>
                              <select class="form-control" name="id_pelanggan" id="pelanggan">
                                ...
                                foreach ($pelanggan as $p)
                                {
                                  ...
                                  echo $penjualan->id_pelanggan==$p->id_pelanggan?'selected':'';
                                  echo ">$p->nama_pelanggan</option>";
                                }
                                ?>
                            </select>
                          </div>
                             ...
                             <label for="text">Proyek</label>
                                <select class="form-control" name="id_proyek" id="proyek">
                                  ...
                                  foreach ($proyek as $pr)
                                  {
                                    ...
                                    echo $penjualan->id_proyek==$pr->id_proyek?'selected':'';
                      ...
                      <td>
                        <div class="form-group col-xs-6">
                          ...
                          <input type="text" class="form-control" name="no_kontrak" value="<?php echo $penjualan->no_kontrak ?>">
                        </div>
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <input type="date" class="form-control" name="tgl_diterima" required="" value="<?php echo $penjualan->tgl_diterima?>">
                        </div>
                        ...
                        <div class="form-group col-xs-6">
                          ...
                          <select class="form-control" name="perihal" id="perihal">
                                  ...
                                  foreach ($perihal as $data)
                                  {
                                    ...
                                    echo $penjualan->perihal==$data->id_perihal?'selected':'';
                    ...
                    <tr>
                      <td>
                        <div class="form-group">
                          ...
                          <div class="col-xs-6">
                            <input type="text" id="biaya" name="biaya" class="form-control" value="<?php echo $penjualan->biaya; ?>" onclick="total_barang()" readonly="" style="text-align: right;">
                          </div>
                        </div>
                      </td>
                      ...
                      <td>
                        <div class="form-group">
                          ...
                          <div class="col-xs-9">
                            <textarea class="form-control" name="total" id="total" style="text-align: right;font-size: 10pt;font-weight: bold;"><?php echo $penjualan->tagihan ?></textarea>
                          </div>
                        </div>
                      </td>
                    </tr>
                    ...
                    <tr>
                      <td>
                          ...
                          <input type="number" name="diskon1" id="diskon1" class="form-control" value="<?php echo $penjualan->diskon1 ?>" onkeyup="total_diskon()" required="" style="font-weight: bold;font-size:14pt">
                          </div>
                          <div class="form-group col-xs-6">
                            <label for="text">Potongan(hasil)</label>
                            <input type="text" name="diskon2" id="diskon2"  class="form-control" value="<?php echo $penjualan->diskon2 ?>" style="text-align: right;font-weight: bold;font-size:14pt" readonly="">
                          </div>
                      </td>
                    </tr>
                    ...
                    <tr>
                      <td>
                        <div class="form-group col-xs-6">
                          ...
                          <input type="text" name="operator" class="form-control" value="<?php echo $penjualan->operator ?>" readonly>
                        </div>
                      </td>
                    </tr>
                      ...
                      <td>
                          <div class="form-group col-xs-6">
                            ...
                            <select class="form-control" name="akun_biaya">
                              ...
                              foreach ($akun as $row) {  
                                ...
                                echo $penjualan->akun_biaya==$row->id_akun?'selected':'';
                          ...
                          <div class="form-group col-xs-6" style="display: none">
                            ...
                            <select class="form-control" name="akun_potongan">
                              ...
                              foreach ($akun as $row) {  
                                echo "<option value='$row->id_akun'";
                                echo $penjualan->akun_potongan==$row->id_akun?'selected':'';
                                echo ">$row->nama_akun</option>";
                           ...
                           <div class="form-group col-xs-6">
                            ...
                            <select class="form-control" name="akun_total">
                              ...
                              foreach ($akun as $row) {  
                                echo "<option value='$row->id_akun'";
                                echo $penjualan->akun_total==$row->id_akun?'selected':'';
                                echo ">$row->nama_akun</option>";
...
function get_harga(id) {
  ...
  $(document).ready(function () {
    var counter = <?php echo count($barang_penjualan);?>;
    var no= <?php echo count($barang_penjualan)+1;?>;
                    var x;
                    for (x=0; x<counter; x++) {
