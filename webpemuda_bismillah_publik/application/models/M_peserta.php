...
class M_peserta extends CI_Model
{
    ...
    function getPesertaByIdPeserta($idPeserta) {
        return $this->db->get_where('peserta',array('idPeserta'=>$idPeserta))->row();

    }

    function addLogin($peserta) {
        $this->db->insert('login',$peserta);
    }
