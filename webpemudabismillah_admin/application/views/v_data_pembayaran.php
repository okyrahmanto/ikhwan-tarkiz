                  ...
                  <table width="100%" border="0" id="table_id" class="table table-bordered table-striped">
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?php
                            $tgl_pembayaran=date_create($tampil->tgl_pembayaran); echo date_format($tgl_pembayaran,"d-m-Y") ?></td>
                            <td><?php
                            if($tampil->jenis_pembayaran=='utang'){
                              echo $tampil->nama_pelanggan;
                            } else{echo $tampil->nama_vendor;}
                            ?></td>
                            ...
                            <td>
                              <a style="display:none;"  href="javascript:;"
                                  ...
                                  <button  data-toggle="modal" data-target="#konfirmasi<?php echo $tampil->id_pembayaran ?>" class="btn btn-success">Konfirmasi</button>
                              </a>
                              <a href="<?php echo base_url() ?>index.php/admin/edit_pembayaran/<?php echo $tampil->id_pembayaran ?>" class="btn btn-warning">Edit</a>
                              <a href="<?php echo base_url() ?>index.php/admin/cetak_transaksi/<?php echo $tampil->id_pembayaran ?>" class="btn btn-warning" target="_blank" style="display: none"><i class="glyphicon glyphicon-print"></i></a>

                              <a href="javascript:;"
                                  data-toggle="modal" data-target="#">
                                  <button  data-toggle="modal" data-target="#hapus<?php echo $tampil->id_pembayaran ?>" class="btn btn-danger"><i class="glyphicon glyphicon-trash"></i></button>
                              </a>
                            </td>
                        </tr>
                    ...
                    <?php
                    foreach($pembayaran as $tampil){
                    $diterima=$tampil->tgl_pembayaran;
...
<!-- Modal Tambah-->
<?php foreach ($pembayaran as $tampil) {
  ?>
<div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="konfirmasi<?php echo $tampil->id_pembayaran ?>" class="modal fade">
        ...
        <div class="modal-content">
            ...
            <form class="form-horizontal" action="<?php echo base_url('index.php/admin/input_konfirmasi/')?><?php echo $tampil->id_transaksi ?>" method="post" enctype="multipart/form-data" role="form">
                  <div class="modal-body">
                    ...
                    <input type="hidden" class="form-control" name="id_transaksi" value="<?php echo $tampil->id_pembayaran ?>">
...
<!-- Modal Tambah-->
<div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="hapus<?php echo $tampil->id_pembayaran ?>" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button aria-hidden="true" data-dismiss="modal" class="close" type="button">×</button>
            ...
            <form class="form-horizontal" action="<?php echo base_url('index.php/admin/hapus_transaksi_pembelian/')?><?php echo $tampil->id_pembayaran ?>" method="post" enctype="multipart/form-data" role="form">
                  <div class="modal-body">
