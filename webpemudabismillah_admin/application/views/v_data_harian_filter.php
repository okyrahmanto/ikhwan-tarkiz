      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
                  <form method="get" action="<?php echo base_url('index.php/admin/laporanharian')?>">
                  Cari Berdasarkan : <br>
                  Tanggal Terima : <input type="radio" name="terima" value="true" checked="true"> | 
                  Tanggal Selesai <input type="radio" name="terima" value="false"> <br>
                    Tanggal Mulai <input type="date" name="tanggal_mulai" id="tanggal_mulai"/> Sampai <input type="date" name="tanggal_akhir" id="tanggal_akhir"/>  <br>
