              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <?php 
                  ...
                  foreach ($dataPeserta as $row) {
                    ...
                    echo '<td>
                      <button type="button" data-toggle="tooltip" data-placement="top" title="Kirim tiket ke peserta" class="btn btn-sm btn-primary"><i class="nav-icon fas fa-envelope"></i></button>
