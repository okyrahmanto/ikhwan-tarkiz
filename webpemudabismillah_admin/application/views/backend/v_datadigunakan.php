        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Berikut semua data yang telah menggunakan tiket yang terkirim</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <div class="row">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <?php 
                  ...
                  foreach ($dataPeserta as $row) {
                   ...
                   echo ' <td><span class="right badge badge-success">Telah Digunakan</span></td>';
                     echo '</tr>';
                  }
